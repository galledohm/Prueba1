...
void TouchPanel_Calibrate(void)
{
	...
	ScreenSample[0].x= 3463; ScreenSample[0].y= 917;
		ScreenSample[1].x=933;   ScreenSample[1].y= 978;
		ScreenSample[2].x=1801;  ScreenSample[2].y= 3092;
