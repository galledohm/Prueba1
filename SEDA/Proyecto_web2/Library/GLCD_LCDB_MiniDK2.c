...
//  LPC_GPIO4->FIOSET    = 0x20000000;
  ...
  // SSEL0 is GPIO output set to high                                         
...
*/	
	LCD_Initializtion();
	//LCD_Configuration();
	driverCod = LCD_ReadReg(0x0000);		/* Read ID	*/	

	
  if (driverCod == 0x47) {             /* LCD with HX8347-D LCD Controller   */
