...
void init_TIMER1(void)
{
    ...
    LPC_TIM1->TCR = 0x03;     											// TC y PC habilitados para contar + reset del timer
		...
		NVIC_EnableIRQ(TIMER1_IRQn);										//Habilitamos interrupción del Timer1
}

//TIMER3 en modo CAP para el anemómetro (ver ejemplo BlackBoard)
