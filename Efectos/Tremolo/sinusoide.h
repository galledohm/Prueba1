#if !defined (_SINUSOIDE_)
#define _SINUSOIDE_
#include <LPC17xx.H>
/*La idea del efecto de tremolo es variar la amplitud de la señal de entrada, es decir, variar su volumen. Para ello
he generado una señal sinusoidal de 1000 ptos y 4095 de amplitud que multiplicando a las muestras de la señal de entrada
consiga este efecto*/
